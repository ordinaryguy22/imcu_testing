...
module crypto_unit (
 ...
 //      else 
  ...
  //  end
    ...
    always_comb begin
        crypto_result = 32'b0;
        enable = get_crypt_en(crypto_ctrl);
       ...
       if (crypto_ctrl == 41) begin
            ...
            case (sha_sel[1:0])
                2'b00: crypto_result = sha256sig0_out;
                2'b01: crypto_result = sha256sig1_out;
                2'b10: crypto_result = sha256sum0_out;
                2'b11: crypto_result = sha256sum1_out;
            endcase
        end
    end
