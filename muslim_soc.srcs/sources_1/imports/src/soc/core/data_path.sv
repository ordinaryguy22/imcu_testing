...
module data_path #(
	...
	`elsif VCS_SIM
        ...
        `elsif VIVADO_SIM
            .RESET_VALUE(32'h10000000)
        `else
            .RESET_VALUE(32'h10000000) // 10000000   fffff000
        `endif
    ) PC_inst (
        .clk(clk),
        .reset_n(reset_n),
    ...
    assign is_mul_id      = r_type_id   & fun7_id[0]      & ~fun3_id[2];
    assign is_div_id      = r_type_id   & fun7_id[0]      &  fun3_id[2];
   ...
   // forwarding mux for rd1 (decode stage)
    ...
    crypto_alu_mux crypto_alu_inst(
            .alu_result(alu_result_exe),
            .crypto_result(crypto_result_exe),
            .result(crypto_alu_result_exe),
            .func5(func5_exe),
            .opcode(opcode_exe),
            .func3(fun3_exe)
            );
    ...
    csr_file csr_file_inst (
        ...
        .exception_i  (1'b0), //(exception_mem ),
        .e_code       (e_code_mem    ),
        .timer_irq    (timer_irq     ),
