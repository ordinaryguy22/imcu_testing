module exception_encoder (
    ...
    localparam logic [3:0] EXC_INST_ADDR_MISALIGNED      = 5'd0;
    localparam logic [3:0] EXC_ILLEGAL_INSTRUCTION       = 5'd2;
    localparam logic [3:0] EXC_LOAD_ADDR_MISALIGNED      = 5'd4;
    localparam logic [3:0] EXC_STORE_AMO_ADDR_MISALIGNED = 5'd6;
    localparam logic [3:0] EXC_ECALL_MMODE               = 5'd11;
