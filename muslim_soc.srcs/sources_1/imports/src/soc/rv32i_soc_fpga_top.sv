...
module rv32i_soc_fpag_top (
    ...
    parameter DMEM_DEPTH = 4096; // 4096;   131072
   ...
   // assign LED    = o_gpio[15:0];
      ...
      assign LED[0] = soc_inst.stall_pipl;
      assign LED[1] = soc_inst.dma_has_access;
      assign LED[2] = soc_inst.dma_stall;
      assign LED[3] = soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.TC;
      assign LED[4] = soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.MC;
      assign LED[5] = soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.TEN;
       assign LED[6] = soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.IMC;
    //  assign LED[12:6] =soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.address_main_memory;
     // assign LED[15:13] = soc_inst.InMemory_Accelerator_Exchange.DMA_IMCU_UNIT.dma_controller_init.state;
...
//    endgenerate
    ...
    assign display_reg = soc_inst.rv32i_core_inst.data_path_inst.reg_file_inst.reg_file[20];   //     current_pc_id
 //  assign display_reg =  soc_inst.data_mem_inst.dmem[168];
