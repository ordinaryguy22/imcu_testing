...
`ifndef PD_BUILD
 ...
 // initializing the instruction memory after every reset
   initial begin
    ...
    //for ubandu//
    // $readmemh("C:/04_FYP/06_SOC/New Integration/version7/SOC_IMCU_integ/SOC_IMCU_integ/hex_code_negativetesting.txt", DUT.inst_mem_inst.dmem);
   //$readmemh("C:/04_FYP/06_SOC/New Integration/version8/SOC_IMCU_integ/SOC_IMCU_integ/hex_code_imcu.txt", DUT.inst_mem_inst.dmem);
//$readmemh("C:/04_FYP/06_SOC/New Integration/version8/SOC_IMCU_integ/SOC_IMCU_integ/instructions_NN.hex", DUT.inst_mem_inst.dmem);
//$readmemh("C:/04_FYP/06_SOC/New Integration/version8/SOC_IMCU_integ/SOC_IMCU_integ/inst.hex", DUT.inst_mem_inst.dmem);
